export const SplashScreenName = 'SplashScreenName';
export const LoginScreenName = 'LoginScreenName';
export const DashboardScreenName = 'DashboardScreenName';
...
export const ScreenInvoiceName = 'ScreenInvoiceName';
